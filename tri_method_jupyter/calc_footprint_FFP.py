...
def plot_footprint(x_2d, y_2d, fs, clevs=None, show_footprint=True, normalize=None,
                   colormap=None, line_width=2, iso_labels=None):
    ...
    if colormap is None: colormap = cm.bone
    ...
    if show_footprint:
        ...
        for f in fs:
            pcol = plt.pcolormesh(x_2d, y_2d, f, cmap='jet', norm=norm)
        plt.xlabel('x [m]')
        plt.ylabel('y [m]')
